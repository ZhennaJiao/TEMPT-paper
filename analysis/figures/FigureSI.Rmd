...
## Figure S6 A-B  samples input concentration(EV-DNA in patients plasma) and coverage 
...
```
## Figure S7 A  The barplot for samples age distribution between control early stage and advanced stage 
...
## Figure S7 B methylation level variance  in 1mb genome between GP and GC
```{r}
...
## Figure S7 C the distribution of %CpG modified level in 1million region in different chromosomes
```{r}
##import data
merge_df <- readRDS("~/methylation/project/EM_seq/analysis/technical/data/ds_1kb_count.rds")
...
## Figure S7 D the distribution of %CpG modified level 
```{r}
##import data
...
## Figure S8 A  Do correlation heatmap about DMR which called between Early and Advanced Stage 
...
## Figure S8 B Do pca about DMR which called between Early and Advanced Stage
...
## pull sample names according gender
...
## Figure S17 A-B scstage_dmr associated gene violin plot
```{r,echo=TRUE}
## import data
...
if (clor=="Cancer") {
    ...
    mycolors <- c("neutrophil"="#8DD3C7","spleen"="#FFFFB3","dendritic cell"="#BEBADA",
     ...
     ## define GP tissues and paried color 

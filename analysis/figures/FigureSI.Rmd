...
```
## Figure S6 A-B  Make a violin plot for the  input concentration of EV-DNA (EV-DNA in patients' plasma) and the coverage of  the DNA sequencing of the genome 
...
print(p5)
```
## Figure S7 C The distribution of %CpG modified level in 1-MB bins in different chromosomes
...
```
## Figure S17 A-B Make violin plot of scstage_dmr associated gene
...
## scstage_meth_dmr 2414 DMR regions
...
## sc stages methylation level matrix 

...
## Fig3C lolipop plot for the annotated  gene elements
```{r}
...
## extract specified rows to do heatmap 
...
## Figure  3G- associated gene at dmr regions between GC and GPdo vilolinplot for all associate genes
```{r,echo=FALSE}
## import data

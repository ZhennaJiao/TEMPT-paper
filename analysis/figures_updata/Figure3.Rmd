...
## Fig3A Plot a heatmap for the correlation between GP and GC on DMRs regions
...
## Fig3B  Calculate PCA for DMR between GC and GP based on the DMR region's methylation level (the matrix removes missing value)
...
## Figure3G  Plot a violin plot for all associated DMR regions between GC and GP.

...
#SBATCH -o /home/jiaozhenna/methylation/project/EM_seq/20241125_data_reanalysis/reprocessing/sample_1x_data_20241209/logs/%j_%x.log
#SBATCH -e /home/jiaozhenna/methylation/project/EM_seq/20241125_data_reanalysis/reprocessing/sample_1x_data_20241209/logs/%j_%x.log
#SBATCH --nodes=1
...
deduplicate_bismark --paired --output_dir ${out_dir} \
                    ${input_dir}/${sample}_L1_1_val_1_bismark_bt2_pe.bam
done

...
## Create blank to store results.

```{r }
samples <-  c("L30-2_new","L121-1","L121-7","L29-1","L29-4_new","L29-7")

proj_dir <- "/home/jiaozhenna/methylation/project/EM_seq/20241125_data_reanalysis/reprocessing/smaple_30x_data_202412/results/08_spikein_call_meth/"
...
kb_fig_dir <- "/home/jiaozhenna/methylation/project/EM_seq/20241125_data_reanalysis/reprocessing/smaple_30x_data_202412/results/05_spikein_QC/fig_2kb_3/"

dir.create(kb_fig_dir, recursive = TRUE)

lambda_dir <- "/home/jiaozhenna/methylation/project/EM_seq/20241125_data_reanalysis/reprocessing/smaple_30x_data_202412/results/05_spikein_QC/fig_lambda/"
...
## Calculate 2kb-3 coverage and methylation rate. 
...
```{r}
  for (i_sample in samples) {
    ...
    #create coverage and CpG methylation rate figure 
...
## Write the lambda result in csv

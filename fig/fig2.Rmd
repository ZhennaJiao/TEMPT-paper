...
##do plot
### transport "total_reads" and  "map_reads" to numeric formation 
...
p1
# ggsave(paste0(fig_dir,"fig2B_barplot_smp_map_reads_20240902.pdf"),plot = p6,width = 4,height =4,dpi = 300)
```
# fig2c
...
##visulization for 2kb_3-lambda methylation conversion rate
p2 <- ggplot(sp_in ,aes(x=type,y=sp_in$`sp_2kb_3-lambda`,fill = type)) +
      ...
      theme(legend.position = "None",
            ...
            axis.title.y = element_text(size = 15, color = "black"),
            axis.line = element_line(size=1,linetype = 1,color = "black"))
# ggsave(paste0(fig_dir,"fig2b_boxplot_5mc_mod.pdf"),plot = p2,width = 4,height = 6,dpi = 300)
print(p2)
mc_data <- sp_in[39:76,]
p3 <- ggplot(mc_data ,aes(x=type,y=mc_data$`sp_2kb_3-lambda`,fill = type)) +
      ...
      theme_classic()+
      theme(legend.position = "None",
            axis.text.x = element_text(size = 15, color = "black",),  # 设置X轴字体大小为12
            axis.text.y = element_text(size = 15, color = "black",),
            axis.title.y = element_text(size = 15, color = "black",),
            axis.line = element_line(size=1,linetype = 1,color = "black"))
# ggsave(paste0(fig_dir,"fig2b_boxplot_5c_mod.pdf"),plot = p3,width = 4,height = 6,dpi = 300)
print(p3)
```
# fig2e
```{r}
...
##compare the significance of difference between control early stage and advanced stage 
